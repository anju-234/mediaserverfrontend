  ...
  return (
    <>
     <div className='d-flex align-items-center'>
      <h5>Upload Videos</h5>
      <Button className='ms-2' onClick={handleShow}><i class="fa-solid fa-arrow-up-from-bracket fa-beat"></i></Button>
     </div>
     {/* Modal */}
     <Modal
        show={show}
      ...
      <FloatingLabel controlId="floatingImage" label="Image Url" className='mb-3'>
